let meals = [
  ...
  {
    title: "Pizza Chilli con Carne",
    ingredient: "• Chilli con Carne, Tomatensauce, Käse",
    priceString: "9,30€",
    price: 9.3,
  },
  {
    title: "Pizza Margaritha Originale",
    ingredient: "•  Tomatensauce, Käse, Basilikum",
    priceString: "8,99€",
    price: 5.99,
  },
  {
    title: "Pizza Hawaii",
    ingredient: "•Tomatensauce, Käse, Schinken, Ananas",
    priceString: "6,99€",
    price: 6.99,
  },
  {
    title: "Mexican Burger",
    ingredient: "•Tomatensauce, Käse, Beef, Chilisauce",
    priceString: "6,99€",
    price: 6.99,
  },
];
  ...
  for (let k = 0; k < 1; k++) {
    ...
    if (remarks[j] != []) {
      document.getElementById(
        `order${j}`
      ).innerHTML += `<div id="remark${j}" class="remark">${remark}`;
    }
  }
}
